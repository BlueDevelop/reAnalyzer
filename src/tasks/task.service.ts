        ...
        aggregations: {
          1: {
            terms: {
              ...
              script: "doc['assign.id.keyword'].value + '|' + doc['assign.name.keyword'].value?:doc['assign.id.keyword'].value + '|' + doc['assign.name.keyword'].value + ' ' + doc['assign.lastname.keyword'].value",
              size: size || 10,
              order: {
                _count: 'desc',
              },
