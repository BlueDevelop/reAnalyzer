...
export class DashboardComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    // this.filterService.getDiscussionNameList().subscribe(data => {
    //   this.model['discussions'].allItems = data;
    // });
    // this.filterService.getProjectNameList().subscribe(data => {
    //   this.model['projects'].allItems = data;
    // });
    ...
    // this.filterService.getUnitNameList().subscribe(data => {
    //   this.model['units'].allItems = data;
    //   this.filteredUnits = this.model['units'].itemSelected.valueChanges.pipe(
    //     startWith(null),
    //     map(
    //       (fruit: string | null) =>
    //         fruit
    //           ? this._filter(fruit, 'units')
    //           : this.model['units'].allItems.map(item => {
    //               return { ...item };
    //             })
    //     )
    //   );
    ...
    // this.filteredDiscussions = this.model[
    //   'discussions'
    // ].itemSelected.valueChanges.pipe(
    //   startWith(null),
    //   map(
    //     (item: string | null) =>
    //       item
    //         ? this._filter(item, 'discussions')
    //         : this.model['discussions'].allItems.slice()
    //   )
    // );

    // this.filteredProjects = this.model[
    //   'projects'
    // ].itemSelected.valueChanges.pipe(
    //   startWith(null),
    //   map(
    //     (item: string | null) =>
    //       item
    //         ? this._filter(item, 'projects')
    //         : this.model['projects'].allItems.slice()
    //   )
    // );
    //}
  }
